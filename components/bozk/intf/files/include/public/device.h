...
bk_error_t bk_dev_read(const bk_dev_fd_t fd, void* buf, const bk_size_t count);
bk_error_t bk_dev_write(const bk_dev_fd_t fd, const void* buf, const bk_size_t count);
